...
===== Viewing Generic Object Classes
...
===== Creating Generic Object Classes
...
Locate the exported yaml file containing the generic object properties in the temporary folder. See below for an example generic object class yaml file:

------
---
- GenericObjectDefinition:
    name: GenericObjectClassName
    description: A generic object definition
    properties:
      :attributes: {}
      :associations: {}
      :methods: []
...
===== Importing Generic Objects Classes

Import generic objects to {product-title_short} from a shared library.

[NOTE]
====
Copy the generic object class yaml file to the desired appliance before following the import procedure.
====
